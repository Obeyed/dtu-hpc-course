...
Moreover, in the first three\todo{visualisations} sections we present plots to illustrate the runtime's development while we expand the array size of the input from $2^0$ to $2^{29}$.
