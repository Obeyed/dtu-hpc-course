...
The idea is illustrated in \cref{fig:coarse bins example}\todo{add coarse bins example}.
...
The next step is to sort all the values w.r.t. the coarse bins in ascending order\todo{is this ascending order?}, i.e. coarse bin 0 is first, followed by coarse bin 1, etc.
...
\todo[inline]{make sure the name of this kernel is the same as in the code \ttt{fire\_up\_local\_bins()}}
